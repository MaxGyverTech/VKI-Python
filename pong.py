...
r = pg.Rect(0,0,50,50)
p1 = pg.Rect(10,300,20,200)
p2 = pg.Rect(1250,300,20,200)
x,y = 4,4
...
while True:
    ...
    if plaing:
        ...
        screen.fill('black')
        pg.draw.circle(screen, 'red', r.center, 25)
        screen.fill('white', p1)
        screen.fill('white', p2)
        screen.blit(font.render(f'{score1}:{score2}', True, 'white'), (600, 0))
    else:
        screen.fill('black')
